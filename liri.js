...
console.log("Enter my-tweets, spotify-this-song, movie-this, or do-what-it-says to play with me!");
...
// 	// Variable for search term, test if defined
	...
	var searchTrack = new spotify(keys.spotify);
...
// 	// Launch spotify search
	searchTrack.search({type:'track', query:searchTrack}, function(err, data){
	    if(err){
